...
private:
  ...
  uint8_t firstPersonVisibleItem = kAir;
  float firstPersonEquipProgress = 0.0f;
  float firstPersonSwingProgress = 0.0f;
  float firstPersonSwingStrength = 1.0f;
  bool firstPersonSwingActive = false;
  float firstPersonUseProgress = 0.0f;
  float firstPersonUseStrength = 1.0f;
  bool firstPersonUseActive = false;
  float firstPersonIdleTime = 0.0f;
  float firstPersonWalkBobPhase = 0.0f;
  float firstPersonWalkBobAmount = 0.0f;
  bool firstPersonMeshUploaded = false;
